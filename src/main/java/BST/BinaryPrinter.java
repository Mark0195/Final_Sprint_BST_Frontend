...
public class BinaryPrinter {
    ...
    static <B> String drawNode(final BinaryNode<B> currentNode, final int lineLength)
    {
        String strNode = "   ";
    ...
    static <B> String stringifyNodeValue(final BinaryNode<B> node)
    {
    ...
    static <B> String drawConnections(final BinaryNode<B> currentNode,
    ...
    static <B> String drawLeftConnectionPart(final BinaryNode<B> currentNode,
                                             final int lineLength)
    {
    ...
    static <B> String drawJunction(final BinaryNode<B> currentNode)
    {
    ...
    static <B> String drawRightConnectionPart(final BinaryNode<B> currentNode,
                                              final int lineLength)
    {
    ...
    public static <B> void nicePrint(final BinaryNode<B> startNode)
    {
        if (startNode == null)
            return;

        final int treeHeight = BinaryHeight.getHeight(startNode);
        ...
        final Queue<Pair<BinaryNode<B>, Integer>> toProcess = new LinkedList<>();
        toProcess.offer(new Pair<>(startNode, 0));

        while (!toProcess.isEmpty() && level < treeHeight)
        {
            final Pair<BinaryNode<B>, Integer> current = toProcess.poll();
            final BinaryNode<B> currentNode = current.first;
